...
public class NotificationServiceImpl implements NotificationService {
    ...
    public NotificationResponse retryNotification(Long id) {
        ...
        if (n.getStatus() != NotificationStatus.FAILED) {
            throw new IllegalStateException("Seules les notifications FAILED peuvent être relancées");
        }
        if (n.getRetryCount() >= MAX_RETRY) {
            throw new IllegalStateException("Limite de retry atteinte (" + MAX_RETRY + ")");
        }
