...
package tn.esprit.pi.service.FollowupProtocol;
...
import tn.esprit.pi.entity.PatientProtocol;
...
import tn.esprit.pi.repository.FollowupProtocolRepository;
import tn.esprit.pi.repository.PatientProtocolRepository;
import tn.esprit.pi.repository.ProtocolExecutionRepository;
import tn.esprit.pi.repository.ProtocolStepRepository;
...
// Assigner un protocole à un patient
    ...
    private PatientProtocol findOrThrow(String id) {
        return patientProtocolRepo.findById(id)
                .orElseThrow(() -> new RuntimeException("PatientProtocol not found: " + id));
    }
